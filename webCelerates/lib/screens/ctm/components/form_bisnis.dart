...
import 'package:celerates/controllers/ctm_controller.dart';
...
class _FormBisnisState extends State<FormBisnis> {
  ...
  final _ctmC = Get.put(CtmController());
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                SizedBox(
                                    width: MediaQuery.of(context).size.width,
                                    child: formInput('Company’s Name*',
                                  ...
                                  child: primaryButton(
                                      ...
                                      onTap: () {
                                        if (_formKey.currentState!.validate()) {
                                          if (_ctmC
                                              .message.value.text.isNotEmpty) {
                                            _ctmC.postBPO(context);
                                          }
                                        }
                                      },
