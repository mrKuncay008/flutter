import 'package:celerates/screens/ctm/components/banner_out.dart';
import 'package:celerates/screens/ctm/components/form_bisnis.dart';
import 'package:celerates/screens/ctm/components/tab_out.dart';
...
class CtmOutSearchingScreen extends StatefulWidget {
  const CtmOutSearchingScreen({Key? key}) : super(key: key);

  @override
  State<CtmOutSearchingScreen> createState() => _CtmOutSearchingScreenState();
}

class _CtmOutSearchingScreenState extends State<CtmOutSearchingScreen> {
          ...
          SizedBox(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  BannerOut(controller: _appBarC.scrollController),
                  const Responsive(
                    mobile: SizedBox(
                      height: 32,
                    ),
